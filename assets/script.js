    ...
    $('.btn').on('click', function() {
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                var icImageThree = 'http://openweathermap.org/img/w/' + iconThree + ".png";
                var icImageFour = 'http://openweathermap.org/img/w/' + iconFour + ".png";
                var icImageFive = 'http://openweathermap.org/img/w/' + iconFive + ".png";
